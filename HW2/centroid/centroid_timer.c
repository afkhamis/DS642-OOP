/******************************************************************************
* FILE: centroid_timer.c
* DESCRIPTION:
*   Timing three methods for computing centroid
*   of millions of two-dimensional coordinates.
*   Adopted from Cornell CS5220
******************************************************************************/
...
void time_centroid (const char* name,
    ...
    tstart = omp_get_wtime(); /* Using OpenMP primitives for timing */
